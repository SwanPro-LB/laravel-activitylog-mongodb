...
class CauserResolver
{
    ...
    public function resolve(Object | int | string | null $subject = null): ?Object
    {
    ...
    protected function resolveUsingId(int | string $subject): Object
    {
    ...
    protected function getCauser(Object | int | string | null $subject = null): ?Object
    {
     ...
     */
    public function setCauser(?Object $causer): static
    {
    ...
    protected function getDefaultCauser(): ?Object
    {
