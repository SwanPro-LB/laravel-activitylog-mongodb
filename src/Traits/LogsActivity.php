...
{       
    ...
    protected static function getActivitylogOptions() {
    ...
    protected static function bootLogsActivity(): void
    {
        ...
        static::eventsToBeRecorded()->each(function ($eventName) {
            ...
            static::$eventName(function (Object $model) use ($eventName) {
    ...
    protected static function getRelatedModelAttributeValue(Object $model, string $attribute): array
    {
    ...
    protected static function getRelatedModelRelationName(Object $model, string $relation): string
    {
        return Arr::first([
            $relation,
            Str::snake($relation),
    ...
    protected static function getModelAttributeJsonValue(Object $model, string $attribute): mixed
    {
